"""Twenty Questions 턴 진행 로직 + 프롬프트 구성.
...
SELECTOR_SYSTEM_PROMPT = """당신은 Twenty Questions 게임의 '질문 선택기'입니다.
...
CANDIDATE_SYSTEM_PROMPT = """당신은 Twenty Questions 게임의 '후보 추정기'입니다.
...
SYSTEM_PROMPT = """당신은 'Twenty Questions 출제자'입니다. 사용자가 머릿속으로 한 가지 대상을 생각하고, \
